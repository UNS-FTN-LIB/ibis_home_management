...
def generateRooms():
    ...
    room2.add_device(device.Device(state=False, name="BLIND1", type=device.DeviceType.BLIND))
    room2.add_device(device.Device(state=False, name="LIGHT1", type=device.DeviceType.LIGHT))
